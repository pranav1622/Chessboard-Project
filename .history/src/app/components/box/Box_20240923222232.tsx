...
const Box: React.FC<BoxProps> = ({ chessObj, chessBoard }) => {
  ...
  const handleMove=()=>{
    ...
    if(currentSelectedPiece.chessColor && currentSelectedPiece.possibleMoveColor !==""){
      ...
      if(currentSelectedPiece && currentSelectedPiece.possibleMoveColor !=="" &&currentBox.possibleMoveColor){
